      ...
      <div className="mt-10 flex md:justify-center gap-10 md:flex-row md:flex-wrap flex-col items-center">
        <ScrollAnimation >
          <div className="bg-foreground-gradient rounded-3xl sm:w-96 h-96 w-80  p-10 flex flex-col items-start justify-end ">
            ...
            <p className='text-gray-500'>At WebLoom, we transform your unique vision into stunning designs that truly reflect your brand and engage your audience.</p>
          </div>
        </ScrollAnimation>
        <ScrollAnimation delay={0.9}>
          <div className="bg-foreground-gradient rounded-3xl sm:w-96 h-96 w-80  p-10 flex flex-col items-start justify-end ">
            ...
            <p className='text-gray-500'>At WebLoom, we adapt our web solutions to support your unique growth journey, ensuring you thrive in an ever-evolving market.</p>
          </div>
        </ScrollAnimation>
        <ScrollAnimation delay={1.1}>
          <div className="bg-foreground-gradient rounded-3xl sm:w-96 h-96 w-80  p-10 flex flex-col items-start justify-end ">
            ...
            <p className='text-gray-500'>At WebLoom, we offer personalized SEO solutions designed to enhance your online visibility and drive targeted traffic to your website.</p>
          </div>
        </ScrollAnimation>
      </div>
      <div className="mt-10 flex md:justify-center gap-10 md:flex-row md:flex-wrap flex-col items-center">

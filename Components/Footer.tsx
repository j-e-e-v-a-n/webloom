    ...
    <div className='mt-10 px-5'>
      <div className="bg-[#131313] rounded-t-3xl  flex flex-col  w-full">
        ...
        <div className="mx-auto flex mt-5 gap-5">
          <Link href="https://instagram.com/weblo0m">
            <Image
          ...
          <Link href="https://www.facebook.com/profile.php?id=61571862298053">
            <Image
          ...
          <Link href="mailto:webloom.ceo@gmail.com">
            <Image
              src="/icons/mail.svg"
              width={20}
              height={20}
        ...
        <div className="md:flex flex-col md:flex-row  mt-10 gap-10 mb-10">
            ...
            <a href='https://weblo0m.vercel.app' className="border min-w-fit mt-5 md:mt-0 border-gray-900 bg-foreground rounded-full px-5 py-4 text-gray-500 w-fit mx-auto hover:border-gray-700 hover:text-gray-400 flex gap-3 items-center">

    ...
    <div className="max-w-4xl mx-auto p-6 mt-40">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-500">
          Welcome to WebLoom! Your privacy and the protection of your personal information are very important to us. This Privacy Policy and Terms & Conditions outline the policies governing the collection, use, and disclosure of your personal data and the terms of use of our services. By using our website or services, you agree to abide by these terms.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-5 text-gray-500">
          <li><strong>Company</strong>: WebLoom, referred to as "we," "us," or "our" in this agreement.</li>
      ...
      <section className="mb-8">
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-500">
            By accessing or using WebLoom’s services, you agree to these Terms & Conditions. If you do not agree with these terms, you must stop using our services immediately.
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-500">
            WebLoom provides web development solutions and technical support. We offer services online only and do not have a physical address. All services are provided as-is.
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-500">
            All content, trademarks, and intellectual property related to WebLoom belong to us or our licensors. You may not copy, distribute, or use our content without permission.
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-500">
            WebLoom is not liable for any damages arising from your use of our services, including but not limited to data loss or unauthorized access.
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-500">
            WebLoom reserves the right to modify this Privacy Policy and Terms & Conditions at any time. We will notify you of changes by updating the date at the top of this document. Continued use of our services indicates your acceptance of any changes.
          </p>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-500">
          If you have any questions or concerns about our Privacy Policy or Terms & Conditions, please contact us at <a href="mailto:webloom.ceo@gmail.com" className="text-blue-500">webloom.ceo@gmail.com</a> 
        </p>
      </section>
    </div>
  )
...
{/* <h2 className='text-3xl font-extrabold'>Privacy Policy and Terms & Conditions</h2>
        <ol className="list-decimal list-inside space-y-4 mt-10">
          <li className='text-xl font-bold'>Introduction</li>
            <p className='max-w-[60ch] text-gray-400'>Welcome to WebLoom! Your privacy and the protection of your personal information are very important to us. This Privacy Policy and Terms & Conditions outline the policies governing the collection, use, and disclosure of your personal data and the terms of use of our services. By using our website or services, you agree to abide by these terms.</p>
          <li className='text-xl font-bold'>Definitions</li>
            <div className='max-w-[60ch] text-gray-400 mb-20'>
              <ul className="list-disc list-inside space-y-1">
                <li>Company: WebLoom, referred to as "we," "us," or "our" in this agreement.</li>

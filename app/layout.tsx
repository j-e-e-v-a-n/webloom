...
export const metadata = {
  ...
  description: "Discover WebLoom, where we specialize in high-quality web development services, including custom landing pages and SEO optimization.",
  openGraph: {
    title: "WebLoom | Expert Web Development Solutions",
    description: "Discover WebLoom, where we specialize in high-quality web development services, including custom landing pages and SEO optimization.",
  ...
  keywords: "WebLoom, web development, landing pages, SEO, custom websites,  webloomdev.s",
  authors: [{ name: "WebLoom", url: baseUrl }], // replace with your URL
  generator: "Next.js",
